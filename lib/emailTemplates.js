...
exports.attorneyInvoiceAlertTemplate = (
  firstName,
  firmName,
  invoiceNumber,
  totalAmount,
  ...
  <head>
    <meta charset="utf-8">
    <title>New Invoice Available – Juris-LPO</title>
  </head>
  <body style="${mainBodyStyle}">
    <div style="${containerStyle}">
      ${header}
      ...
      <p style="color: ${lightTextColor}; line-height: 1.6; font-size: 15px;">
        A new invoice has been generated for <strong>${firmName}</strong> based on completed billable work.
      </p>
      ...
      <p style="color: ${lightTextColor}; line-height: 1.6; font-size: 15px;">
        You can review detailed time logs, line items, and invoice status directly from your dashboard.
      </p>

      <div style="margin: 32px 0; text-align: center;">
        <a 
          href="${invoiceLink}" 
          style="background-color: ${brandColor}; color: #ffffff; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 15px; display: inline-block;"
        >
          View Invoice
        </a>
      </div>

      <p style="color: ${lightTextColor}; line-height: 1.6; font-size: 14px;">
        If you have any questions regarding this invoice, feel free to reach out through the Juris-LPO platform.
      </p>
